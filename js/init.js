...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			'global':	{ range: '*', href: 'css/style.css', grid: { gutters: 50 } },
			'desktop':	{ range: '737-', href: 'css/style-desktop.css', containers: 960 },
			'1000px':	{ range: '737-1200', href: 'css/style-1000px.css', viewport: { width: 1080 } },
